defmodule RobotRaceWeb.LobbyLive do
  ...
  @winning_score 25
  @simulation_interval 200  # Run simulation steps every 1000ms (1 second)
    ...
    |> Enum.map(fn robot ->
      ...
      score_increase = 
        case :rand.uniform(10) do
          1 -> 0  # 10% chance to not move (stuck)
          n when n in 2..7 -> 1  # 60% chance to move 1 space (normal)
          _ -> 2  # 30% chance to move 2 spaces (boost)
        end
